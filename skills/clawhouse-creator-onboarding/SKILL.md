...
strategy. Default to NEAR/USDC spot rebalancing, or to non-yield spot assets
from an explicit allowlist already shown in the chat. Do not name `stNEAR`,
LST/LSD assets, liquid staking derivatives, yield-bearing tokens, staking
tokens, vault tokens, or vague buckets like "established tokens" as executable
assets. Do not invent yield farming, staking, lending, LPing, vaults, Aave,
...
Do not name `stNEAR`, LST/LSD assets, liquid staking derivatives,
yield-bearing tokens, staking tokens, vault tokens, or "established tokens" as
default executable assets unless JY has provided an explicit non-yield asset
allowlist that includes them.
...
The current required onboarding skill version is `0.1.11`.
